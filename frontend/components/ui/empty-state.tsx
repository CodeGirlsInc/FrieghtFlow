...
export function EmptyShipments({ onCreate }: { onCreate?: () => void }) {
  return (
    <EmptyState
      ...
      cta={
        onCreate
          ? { label: "Create your first shipment", onClick: onCreate }
          : undefined
      }
    />
  );
...
export function EmptyDocuments({ onUpload }: { onUpload?: () => void }) {
  return (
    <EmptyState
      ...
      cta={
        onUpload ? { label: "Upload a document", onClick: onUpload } : undefined
      }
    />
  );
}
  ...
  return (
    <EmptyState
      illustration={
        ...
        >
          <path
            d="M40 14a20 20 0 0 1 20 20v10l6 8H14l6-8V34A20 20 0 0 1 40 14z"
            stroke="currentColor"
            strokeWidth="2.5"
            fill="none"
          />
          <path
            d="M34 62a6 6 0 0 0 12 0"
            stroke="currentColor"
            strokeWidth="2.5"
            strokeLinecap="round"
            fill="none"
...
export function EmptyBids() {
  return (
    <EmptyState
      ...
      title="No bids yet"
      description="You haven't submitted any bids yet. Browse the marketplace to get started."
