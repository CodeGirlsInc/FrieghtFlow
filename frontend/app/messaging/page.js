...
import { MessageSquare, Star, Archive, Clock, Filter, Plus } from "lucide-react"
  ...
  if (conversationId === "conv-001") {
    return [
      ...
      },
      {
        id: "msg-004",
        content:
          "I've included those details in the shipping instructions. The carrier has acknowledged and will provide the necessary equipment.",
      ...
      },
      {
        id: "msg-008",
        content:
          "I've also prepared a contingency plan in case of any delays due to the forecasted weather conditions.",
    ...
    return [
      ...
      },
      {
        id: "msg-208",
        content:
          "The medical supplies for St. Luke's Hospital and the perishable goods for FreshMart are our priorities.",
...
export default function MessagingPage() {
  ...
  const handleStartConversation = (contact) => {
    ...
    const existingConv = conversations.find((conv) => conv.type === "direct" && conv.name === contact.name)
      ...
      if (msg.id === messageId) {
        ...
        if (existingReactionIndex >= 0) {
          ...
          if (existingReaction) {
            ...
            return {
              ...msg,
              reactions: msg.reactions.map((r) => (r.emoji === emoji ? { ...r, users: [...r.users, "You"] } : r)),
            }
          } else {
            // Add new reaction
            return {
        ...
        <div className="p-4 border-b">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-2">
              <Button variant="ghost" size="icon" onClick={() => setShowSearchMessages(true)}>
                <Filter className="h-5 w-5" />
              </Button>
              <Button variant="ghost" size="icon" onClick={() => setShowContactsPanel(true)}>
          ...
          <SearchMessages onSearch={setSearchQuery} placeholder="Search conversations..." />
        </div>
      ...
      <div className={`flex-1 flex flex-col ${isMobile && !selectedConversation ? "hidden" : "block"}`}>
        {selectedConversation ? (
          <>
            ...
            <MessageThread messages={messages} onAddReaction={handleAddReaction} />
