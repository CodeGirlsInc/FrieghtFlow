    ...
    <div className="open_sans"  >
      ...
      <section className=" w-full max-w-[1247.7px] flex flex-col gap-[150px] items-center justify-center bg-[#ffffff] py-[10%] px-[4%] mx-auto " >
        ...
        <div className="w-full flex items-center  flex-wrap gap-4 justify-between  " >
          ...
          <div className=" flex flex-col gap-1 md:gap-5 max-w-[340px] items-start mx-auto lg:mx-0 " >
          ...
          <div className=" flex flex-col items-center justify-center gap-8 mx-auto md:mx-0  " >
            <Image src={"/grid-img-1.jpeg"} alt="image" height={217.2} width={692.4} className="bg-cover rounded-[26.4px] h-[150px] lg:h-[217.2px]  w-[300px] lg:w-[692.4px]  " />
            <div className=" relative  mb-[120px] " >
              <Image src={"/grid-img-2.jpeg"} alt="image" height={317.2} width={692.4} className="bg-cover rounded-[26.4px] h-[200px] w-[306.2px]   lg:h-[317.2px] lg:w-[692.4px] " />


              <div className=" absolute left-[-10%] top-[50%] bg-[#FFFFFF] p-2 md:p-4 rounded-[26.4px] " >

                <div className="w-full h-full relative " >
                  <Image src={"/grid-img-3.jpeg"} alt="image" height={337.2} width={326.3} className="bg-cover rounded-[26.4px] h-[140px] w-[143.15px]   lg:h-[337px] lg:w-[326.3px]  " />




                  <div className=" flex flex-col items-center justify-center  absolute bg-[#B57704] h-[84.6px] w-[109.6px]  lg:h-[169.2px] lg:w-[217.2px] right-[-50%] bottom-7 rounded-[19.2px] stats-shadow  " >
                    <h2 className="font-semibold text-2xl lg:text-[57.6px] lg:leading-[57.6px] text-[#ffffff] " > 1500+ </h2>
                    <p className="font-semibold text-base lg:text-[28.8px] lg:leading-[28.8px] text-[#ffffff] "  >shipments</p>
                  </div>
                </div>
              </div>
