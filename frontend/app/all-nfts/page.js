...
export default function NFTsPage() {
  ...
  const nfts = [
    {
      ...
      description:
        "Awarded to early adopters who completed the first blockchain puzzle.",
      rarity: "Common",
    ...
    },
    {
      ...
      image: "/placeholder.svg?height=300&width=300",
      description:
        "For explorers who've mastered the basics of StarkNet technology.",
      rarity: "Rare",
      category: "Achievement",
      obtained: true,
      holders: 587,
    ...
    },
    {
      ...
      image: "/placeholder.svg?height=300&width=300",
      description:
        "Reserved for those who solve the advanced cryptography challenge.",
      rarity: "Epic",
      category: "Achievement",
      obtained: false,
      holders: 124,
    ...
    },
    {
      ...
      image: "/placeholder.svg?height=300&width=300",
      description:
        "Unlocks special areas in the treasure hunt. Limited edition.",
      rarity: "Legendary",
      category: "Utility",
      obtained: false,
      holders: 50,
    ...
    },
    {
      ...
      image: "/placeholder.svg?height=300&width=300",
      description:
        "Grants access to exclusive community events and discussions.",
      rarity: "Common",
      category: "Utility",
      obtained: true,
      holders: 2500,
    ...
    },
    {
      ...
      image: "/placeholder.svg?height=300&width=300",
      description:
        "Only awarded to those who complete all challenges in the universe.",
      rarity: "Legendary",
      category: "Achievement",
      obtained: false,
      holders: 12,
  ...
  const categories = [
    "all",
    ...new Set(nfts.map((nft) => nft.category.toLowerCase())),
  ];
  const rarities = [
    "all",
    ...new Set(nfts.map((nft) => nft.rarity.toLowerCase())),
  ];
  ...
  const filteredNFTs = nfts.filter((nft) => {
    ...
    const matchesRarity =
      rarityFilter === "all" || nft.rarity.toLowerCase() === rarityFilter;
    const matchesCategory =
      categoryFilter === "all" || nft.category.toLowerCase() === categoryFilter;
      ...
      <div className="relative max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg sm:text-xl mb-8 text-gray-300 max-w-2xl mx-auto">
            Explore and collect unique digital treasures earned through solving
            puzzles and completing challenges.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {filteredNFTs.map((nft) => (
            ...
            >
              <div className="relative">
                <div
                  className={`absolute top-0 right-0 m-4 px-2 py-1 rounded-full text-xs font-bold text-white ${
                ...
                <div className="mb-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {nft.attributes.map((attr, index) => (
                      <div
                        key={index}
                        className="bg-white/10 rounded-md p-2 text-xs"
                      >
        ...
        <div className="mt-16 text-center">
          ...
          <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
            Continue your adventure to collect all available NFT rewards. Some
            are extremely rare and only obtainable through special challenges.
          </p>
