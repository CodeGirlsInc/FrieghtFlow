...
export default function BillingPage() {
  ...
  return (
    <div className="container mx-auto py-6 max-w-7xl">
      <BillingHeader billingData={billingData} updateBillingData={updateBillingData} />
      ...
      <div className="mt-8">
        <Tabs defaultValue="overview" className="w-full">
          ...
          <TabsContent value="payment">
            <Card className="p-6">
              <div className="space-y-6">
                <PaymentMethods billingData={billingData} updateBillingData={updateBillingData} />
                <BillingAddress billingData={billingData} updateBillingData={updateBillingData} />
              </div>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="plans">
            <Card className="p-6">
              <SubscriptionManagement billingData={billingData} updateBillingData={updateBillingData} />
            </Card>
          </TabsContent>

          <TabsContent value="tax">
            <Card className="p-6">
              <TaxInformation billingData={billingData} updateBillingData={updateBillingData} />
            </Card>
          </TabsContent>
        </Tabs>
      </div>
