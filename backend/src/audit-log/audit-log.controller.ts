...
export class AuditLogController {
  ...
  // @Roles('admin', 'auditor')
  async getUserLogs(@Query('userId') userId: string, @Query('limit') limit?: number) {
  ...
  @Get("logs/entity")
  // @Roles('admin', 'auditor')
  async getEntityLogs(@Query('entityType') entityType: string, @Query('entityId') entityId: string) {
