...
describe("HealthService", () => {
  ...
  beforeEach(async () => {
    ...
    repository = module.get<Repository<HealthCheck>>(getRepositoryToken(HealthCheck))
  })
  ...
  describe("checkOverallHealth", () => {
    ...
    it("should handle checker exceptions", async () => {
      ;(mockHealthChecker.check as jest.Mock).mockRejectedValue(new Error("Checker failed"))
      mockRepository.create.mockReturnValue({})
      mockRepository.save.mockResolvedValue({})
