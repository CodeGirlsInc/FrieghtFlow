...
describe("FileValidationService", () => {
  ...
  describe("validateFile", () => {
    ...
    it("should reject invalid file extension", () => {
      ...
      expect(result.isValid).toBe(false)
      expect(result.errors).toContain(expect.stringContaining("File extension .txt is not allowed"))
    })
    ...
    it("should provide warnings for potentially corrupted files", () => {
      ...
      expect(result.warnings).toContain(expect.stringContaining("may be corrupted"))
    })
  })
  ...
  describe("validateUploadRequest", () => {
    it("should validate request with required fields", () => {
      ...
      const result = service.validateUploadRequest(dto, DocumentType.BILL_OF_LADING)
