...
describe("FileStorageService", () => {
  ...
  describe("storeFile", () => {
    ...
    it("should store file locally when S3 is disabled", async () => {
      ...
      const result = await service.storeFile(mockFile, "BILL_OF_LADING", "user-123")
    ...
    it("should handle storage errors", async () => {
      ...
      await expect(service.storeFile(mockFile, "BILL_OF_LADING")).rejects.toThrow("File storage failed")
    })
  })
  ...
  describe("deleteFile", () => {
    ...
    it("should handle deletion errors gracefully", async () => {
      ...
      await expect(service.deleteFile("/path/to/file.pdf")).resolves.toBeUndefined()
    })
  })
  ...
  describe("getFileStream", () => {
    ...
    it("should handle read errors", async () => {
      ...
      await expect(service.getFileStream("/path/to/file.pdf")).rejects.toThrow("File retrieval failed")
    })
  })
})
