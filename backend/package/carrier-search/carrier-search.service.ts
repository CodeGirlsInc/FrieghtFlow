...
const MOCK_CARRIERS: CarrierResult[] = [
  {
    ...
    rating: 4.8,
    completedShipments: 1820,
    vehicleTypes: ['truck', 'van'],
    available: true,
    routes: [
      { origin: 'Lagos', destination: 'Abuja' },
      { origin: 'Kano', destination: 'Lagos' },
    ],
  },
  {
    id: 'c2',
    name: 'Eagle Freight Co.',
    rating: 4.2,
    completedShipments: 540,
    vehicleTypes: ['truck'],
    available: true,
    routes: [{ origin: 'Ibadan', destination: 'Kano' }],
  },
  {
    id: 'c3',
    name: 'Meridian Cargo',
    rating: 3.9,
    completedShipments: 300,
    vehicleTypes: ['van', 'motorcycle'],
    available: false,
    routes: [{ origin: 'Lagos', destination: 'Port Harcourt' }],
  },
  {
    id: 'c4',
    name: 'Atlas Express',
    ...
    vehicleTypes: ['truck', 'flatbed'],
    available: true,
    routes: [{ origin: 'Abuja', destination: 'Enugu' }],
  },
  {
    id: 'c5',
    name: 'Horizon Shipping',
    rating: 4.6,
    completedShipments: 1200,
    vehicleTypes: ['truck'],
    available: true,
    routes: [{ origin: 'Kano', destination: 'Abuja' }],
  },
  {
    id: 'c6',
    name: 'Apex Freight',
    rating: 2.8,
    completedShipments: 90,
    vehicleTypes: ['van'],
    available: true,
    routes: [{ origin: 'Benin City', destination: 'Lagos' }],
  },
  {
    id: 'c7',
    name: 'Delta Carriers',
    rating: 4.1,
    completedShipments: 430,
    vehicleTypes: ['refrigerated truck'],
    available: false,
    routes: [{ origin: 'Lagos', destination: 'Kano' }],
  },
  {
    id: 'c8',
    name: 'Coastal Haul',
    rating: 3.5,
    completedShipments: 210,
    vehicleTypes: ['flatbed', 'truck'],
    available: true,
    routes: [{ origin: 'Calabar', destination: 'Abuja' }],
  },
];
